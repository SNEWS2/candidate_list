...
Currently only version 1 and version 2 of the RSG list is completed however other supermassive star list with less rigorous anaylisis will be upload for Wolf-Rayet and other supermassive stars
